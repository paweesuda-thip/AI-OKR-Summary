                ...
                return (
                  ...
                  >
                    ...
                    <div className="hidden lg:flex justify-center items-center h-full relative">
                      ...
                      <span className={`font-mono text-2xl italic font-black relative z-10 drop-shadow-xl ${person.displayRank === 1 ? 'text-transparent bg-clip-text bg-linear-to-b from-yellow-200 to-amber-600' :
                    ...
                    <div className="flex items-center justify-between lg:justify-end mt-3 lg:mt-0 pt-3 lg:pt-0 border-t border-white/5 lg:border-0 grow lg:grow-0 order-4">
                      ...
                      <div className="flex items-center gap-2.5 bg-black/20 lg:bg-transparent px-3 py-1.5 lg:p-0 rounded-lg lg:rounded-none">
                        ...
                        <Tooltip>
                          <TooltipTrigger>
                            <div className={`p-1.5 rounded-lg border shadow-inner bg-background cursor-pointer hover:opacity-80 transition-opacity ${person.trend === 'up' ? 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400' :
