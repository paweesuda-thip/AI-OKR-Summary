 ...
 *
 * Moved verbatim from the former `app/api/chat/route.ts`.
 */
    ...
    try {
      ...
      if (!apiKey) {
        ...
        return NextResponse.json({
          message:
            'This is a simulated response because the API key is missing. If you want a real AI response, please provide the Anthropic API key.',
        });
      }
