  ...
  return (
    <header className="w-full h-16 shrink-0 bg-[#050505]/95 backdrop-blur-2xl border-b border-white/5 flex items-center justify-between px-4 sm:px-8 z-50 sticky top-0 shadow-2xl">
      ...
      <div className="flex items-center gap-3.5 group cursor-pointer transition-transform duration-500 hover:scale-[1.02]">
        <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-rose-500/20 via-fuchsia-500/20 to-cyan-500/20 border border-fuchsia-500/30 text-fuchsia-400 shadow-[0_0_20px_rgba(217,70,239,0.2)] group-hover:shadow-[0_0_30px_rgba(217,70,239,0.5)] transition-all duration-500 overflow-hidden relative">
        ...
        <div className="flex flex-col">
          <h1 className="text-xl sm:text-2xl font-black tracking-[0.2em] uppercase leading-tight font-sans drop-shadow-[0_0_15px_rgba(217,70,239,0.4)] group-hover:drop-shadow-[0_0_25px_rgba(6,182,212,0.6)] transition-all duration-500">
            <ShinyText 
              text="StatioOKR" 
              speed={3} 
